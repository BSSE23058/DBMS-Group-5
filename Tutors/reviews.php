...
<head>
  ...
  <title>Course Reviews - SkillConnect</title>
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                      <?php if (!empty($review['student_photo'])): ?>
                        <img src="<?= htmlspecialchars($review['student_photo']) ?>" class="student-avatar"
                    ...
                    <?php else: ?>
                      <form method="POST" class="mt-3">
                        ...
                        <div class="mb-2">
                          ...
                          <textarea class="form-control" id="response_<?= $review['review_id'] ?>" name="response" rows="2"
                            required></textarea>
                        </div>
